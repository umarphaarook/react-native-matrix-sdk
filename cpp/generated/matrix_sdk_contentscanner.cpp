...
// it!
#include "matrix_sdk_contentscanner.hpp"
...
void ffi_matrix_sdk_contentscanner_rust_future_poll_u8(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_matrix_sdk_contentscanner_rust_future_cancel_u8(
    /*handle*/ uint64_t handle);
void ffi_matrix_sdk_contentscanner_rust_future_free_u8(
    /*handle*/ uint64_t handle);
uint8_t ffi_matrix_sdk_contentscanner_rust_future_complete_u8(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_matrix_sdk_contentscanner_rust_future_poll_i8(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_matrix_sdk_contentscanner_rust_future_cancel_i8(
    /*handle*/ uint64_t handle);
void ffi_matrix_sdk_contentscanner_rust_future_free_i8(
    /*handle*/ uint64_t handle);
int8_t ffi_matrix_sdk_contentscanner_rust_future_complete_i8(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_matrix_sdk_contentscanner_rust_future_poll_u16(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_matrix_sdk_contentscanner_rust_future_cancel_u16(
    /*handle*/ uint64_t handle);
void ffi_matrix_sdk_contentscanner_rust_future_free_u16(
    /*handle*/ uint64_t handle);
uint16_t ffi_matrix_sdk_contentscanner_rust_future_complete_u16(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_matrix_sdk_contentscanner_rust_future_poll_i16(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_matrix_sdk_contentscanner_rust_future_cancel_i16(
    /*handle*/ uint64_t handle);
void ffi_matrix_sdk_contentscanner_rust_future_free_i16(
    /*handle*/ uint64_t handle);
int16_t ffi_matrix_sdk_contentscanner_rust_future_complete_i16(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_matrix_sdk_contentscanner_rust_future_poll_u32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_matrix_sdk_contentscanner_rust_future_cancel_u32(
    /*handle*/ uint64_t handle);
void ffi_matrix_sdk_contentscanner_rust_future_free_u32(
    /*handle*/ uint64_t handle);
uint32_t ffi_matrix_sdk_contentscanner_rust_future_complete_u32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_matrix_sdk_contentscanner_rust_future_poll_i32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_matrix_sdk_contentscanner_rust_future_cancel_i32(
    /*handle*/ uint64_t handle);
void ffi_matrix_sdk_contentscanner_rust_future_free_i32(
    /*handle*/ uint64_t handle);
int32_t ffi_matrix_sdk_contentscanner_rust_future_complete_i32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_matrix_sdk_contentscanner_rust_future_poll_u64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_matrix_sdk_contentscanner_rust_future_cancel_u64(
    /*handle*/ uint64_t handle);
void ffi_matrix_sdk_contentscanner_rust_future_free_u64(
    /*handle*/ uint64_t handle);
uint64_t ffi_matrix_sdk_contentscanner_rust_future_complete_u64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_matrix_sdk_contentscanner_rust_future_poll_i64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_matrix_sdk_contentscanner_rust_future_cancel_i64(
    /*handle*/ uint64_t handle);
void ffi_matrix_sdk_contentscanner_rust_future_free_i64(
    /*handle*/ uint64_t handle);
int64_t ffi_matrix_sdk_contentscanner_rust_future_complete_i64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_matrix_sdk_contentscanner_rust_future_poll_f32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_matrix_sdk_contentscanner_rust_future_cancel_f32(
    /*handle*/ uint64_t handle);
void ffi_matrix_sdk_contentscanner_rust_future_free_f32(
    /*handle*/ uint64_t handle);
float ffi_matrix_sdk_contentscanner_rust_future_complete_f32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_matrix_sdk_contentscanner_rust_future_poll_f64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_matrix_sdk_contentscanner_rust_future_cancel_f64(
    /*handle*/ uint64_t handle);
void ffi_matrix_sdk_contentscanner_rust_future_free_f64(
    /*handle*/ uint64_t handle);
...
void ffi_matrix_sdk_contentscanner_rust_future_poll_rust_buffer(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_matrix_sdk_contentscanner_rust_future_cancel_rust_buffer(
    /*handle*/ uint64_t handle);
void ffi_matrix_sdk_contentscanner_rust_future_free_rust_buffer(
    /*handle*/ uint64_t handle);
RustBuffer ffi_matrix_sdk_contentscanner_rust_future_complete_rust_buffer(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_matrix_sdk_contentscanner_rust_future_poll_void(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_matrix_sdk_contentscanner_rust_future_cancel_void(
    /*handle*/ uint64_t handle);
void ffi_matrix_sdk_contentscanner_rust_future_free_void(
    /*handle*/ uint64_t handle);
void ffi_matrix_sdk_contentscanner_rust_future_complete_void(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
uint32_t ffi_matrix_sdk_contentscanner_uniffi_contract_version();
}

namespace uniffi::matrix_sdk_contentscanner {
...
template <typename T> struct Bridging<ReferenceHolder<T>> {
  ...
  static T fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    if (obj.hasProperty(rt, "pointee")) {
      ...
      return uniffi::matrix_sdk_contentscanner::Bridging<T>::fromJs(
...
template <> struct Bridging<RustBuffer> {
  static RustBuffer rustbuffer_alloc(int32_t size) {
    ...
    return ffi_matrix_sdk_contentscanner_rustbuffer_alloc(size, &status);
  }

  static void rustbuffer_free(RustBuffer buf) {
    RustCallStatus status = {UNIFFI_CALL_STATUS_OK};
    ffi_matrix_sdk_contentscanner_rustbuffer_free(buf, &status);
  }

  static RustBuffer rustbuffer_from_bytes(ForeignBytes bytes) {
    RustCallStatus status = {UNIFFI_CALL_STATUS_OK};
    return ffi_matrix_sdk_contentscanner_rustbuffer_from_bytes(bytes, &status);
  }
...
namespace uniffi::matrix_sdk_contentscanner::registry {
...
// Callback function:
// uniffi::matrix_sdk_contentscanner::cb::rustfuturecontinuationcallback::UniffiRustFutureContinuationCallback
//
...
namespace uniffi::matrix_sdk_contentscanner::cb::
    rustfuturecontinuationcallback {
using namespace facebook;
...
makeCallbackFunction( // uniffi::matrix_sdk_contentscanner::cb::rustfuturecontinuationcallback
    jsi::Runtime &rt,
    std::shared_ptr<uniffi_runtime::UniffiCallInvoker> callInvoker,
    const jsi::Value &value) {
  if (rsLambda != nullptr) {
...
// This method is called from the destructor of NativeMatrixSdkContentscanner,
...
static void cleanup() {
  ...
  // uniffi::matrix_sdk_contentscanner::cb::rustfuturecontinuationcallback
  // Implementation of callback function calling from Rust to JS
  // ForeignFutureDroppedCallback

// Callback function:
// uniffi::matrix_sdk_contentscanner::cb::foreignfuturedroppedcallback::UniffiForeignFutureDroppedCallback
//
// We have the following constraints:
// - we need to pass a function pointer to Rust.
// - we need a jsi::Runtime and jsi::Function to call into JS.
...
// We then give the `callback` function pointer to Rust which will call the
// lambda sometime in the future.
namespace uniffi::matrix_sdk_contentscanner::cb::foreignfuturedroppedcallback {
using namespace facebook;
...
makeCallbackFunction( // uniffi::matrix_sdk_contentscanner::cb::foreignfuturedroppedcallback
    jsi::Runtime &rt,
    std::shared_ptr<uniffi_runtime::UniffiCallInvoker> callInvoker,
    const jsi::Value &value) {
  if (rsLambda != nullptr) {
...
static void cleanup() {
  ...
  // uniffi::matrix_sdk_contentscanner::cb::foreignfuturedroppedcallback
...
template <> struct Bridging<UniffiForeignFutureDroppedCallbackStruct> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    rsObject.free = uniffi::matrix_sdk_contentscanner::cb::
...
template <> struct Bridging<UniffiForeignFutureResultU8> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    rsObject.call_status =
        uniffi::matrix_sdk_contentscanner::Bridging<RustCallStatus>::fromJs(
...
template <> struct Bridging<UniffiForeignFutureCompleteU8> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::matrix_sdk_contentscanner::Bridging<
...
template <> struct Bridging<UniffiForeignFutureResultRustBuffer> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    rsObject.return_value =
        uniffi::matrix_sdk_contentscanner::Bridging<RustBuffer>::fromJs(
            rt, callInvoker, jsObject.getProperty(rt, "returnValue"));
    rsObject.call_status =
        uniffi::matrix_sdk_contentscanner::Bridging<RustCallStatus>::fromJs(
            rt, callInvoker, jsObject.getProperty(rt, "callStatus"));
...
template <> struct Bridging<UniffiRustFutureContinuationCallback> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
         const jsi::Value &value) {
    try {
      return uniffi::matrix_sdk_contentscanner::cb::
...
NativeMatrixSdkContentscanner::NativeMatrixSdkContentscanner(
    jsi::Runtime &rt,
  ...
  props["ubrn_ffi_matrix_sdk_contentscanner_uniffi_contract_version"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "ubrn_ffi_matrix_sdk_contentscanner_uniffi_contract_version"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_ffi_matrix_sdk_contentscanner_uniffi_contract_version(
                    rt, thisVal, args, count);
          });
}

void NativeMatrixSdkContentscanner::registerModule(
    jsi::Runtime &rt, std::shared_ptr<react::CallInvoker> callInvoker) {
  auto invoker =
      std::make_shared<uniffi_runtime::UniffiCallInvoker>(callInvoker);
  auto tm = std::make_shared<NativeMatrixSdkContentscanner>(rt, invoker);
  auto obj = rt.global().createFromHostObject(rt, tm);
  rt.global().setProperty(rt, "NativeMatrixSdkContentscanner", obj);
}

void NativeMatrixSdkContentscanner::unregisterModule(jsi::Runtime &rt) {
  uniffi::matrix_sdk_contentscanner::registry::clearRegistry();
}

jsi::Value NativeMatrixSdkContentscanner::get(jsi::Runtime &rt,
...
NativeMatrixSdkContentscanner::getPropertyNames(jsi::Runtime &rt) {
...
void NativeMatrixSdkContentscanner::set(jsi::Runtime &rt,
                                        const jsi::PropNameID &name,
                                        const jsi::Value &value) {
...
jsi::Value NativeMatrixSdkContentscanner::
...
jsi::Value NativeMatrixSdkContentscanner::
    cpp_ffi_matrix_sdk_contentscanner_uniffi_contract_version(
        jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
        size_t count) {
  auto value = ffi_matrix_sdk_contentscanner_uniffi_contract_version();
