 ...
 *
 * `root` is the repository root rather than this directory, so Metro watches the
 * whole workspace. That covers both cross-directory imports this app makes: the
 * library's `src/`, and the bare example's `src/App.tsx`, which this app renders
