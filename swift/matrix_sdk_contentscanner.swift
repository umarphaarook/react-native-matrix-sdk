...
#if canImport(matrix_sdk_contentscannerFFI)
import matrix_sdk_contentscannerFFI
#endif
...
public func FfiConverterTypeErrorReason_lift(_ buf: RustBuffer) throws -> ErrorReason {
    return try FfiConverterTypeErrorReason.lift(buf)
}
...
public func FfiConverterTypeErrorReason_lower(_ value: ErrorReason) -> RustBuffer {
    return FfiConverterTypeErrorReason.lower(value)
}
